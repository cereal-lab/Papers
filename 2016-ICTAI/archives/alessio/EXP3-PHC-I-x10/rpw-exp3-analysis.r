...
# for that data.
getObjData = function() {
  rawData.CHC  = read.table('P-CHC/bst.problem.all',   header=F)
  rawData.PHCI = read.table('P-PHC-I/bst.problem.all', header=F)
  rawData.PHCP = read.table('P-PHC-P/bst.problem.all', header=F)
...
getDispData = function() {
  rawData.CHC  = read.table('P-CHC/diff.problem.individual.byrun',   header=F)
  rawData.PHCI = read.table('P-PHC-I/diff.problem.individual.byrun', header=F)
  rawData.PHCP = read.table('P-PHC-P/diff.problem.individual.byrun', header=F)
