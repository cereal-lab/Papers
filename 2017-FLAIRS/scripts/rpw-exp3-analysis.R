...
# for that data.
getObjData = function() {
  rawData.CHC  = read.table('./PCHC/bst.test.all',   header=F)
  rawData.PHCI = read.table('./PPHCI/bst.test.all', header=F)
  rawData.PHCP = read.table('./PPHC/bst.test.all', header=F)
